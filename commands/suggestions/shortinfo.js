...
module.exports = {
	...
	do: async (locale, message, client, args, Discord) => {
		...
		qSuggestionDB.anon ? embed.setAuthor(string(locale, "ANON_SUGGESTION"), client.user.displayAvatarURL({format: "png"})) : embed.setAuthor(string(locale, "SUGGESTION_FROM_TITLE", { user: suggester.username }), suggester.displayAvatarURL({dynamic: true, format: "png"}));
