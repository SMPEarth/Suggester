...
All data and bot services are protected by authentication and access is limited to a small subset of users (developers and, for some data, Suggester Staff members). If you believe you have found a security issue in one of our systems, do **not** post in a public chat, open a support ticket in our [support server](https://suggester.js.org/support) instead.
